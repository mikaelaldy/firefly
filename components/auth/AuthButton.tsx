  ...
  return (
    <div className="flex flex-col items-center gap-2">
      <button
        ...
        className="px-4 py-2 text-sm font-medium text-white bg-blue-500 hover:bg-blue-600 disabled:bg-blue-400 rounded-md transition-colors flex items-center gap-2"
      >
        {isSigningIn ? (
          <>
